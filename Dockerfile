...
RUN ln -s "/code/simple_mind/vendor/tk/ticket" ~/.local/bin/tk && uv tool install -e /code/simple_mind/vendor/mng/libs/mngr && mngr plugin add --path vendor/mng/libs/mngr_modal/ --path vendor/mng/libs/mngr_llm/ --path vendor/mng/libs/mngr_mind --path vendor/mng/libs/mngr_claude --path vendor/mng/libs/mngr_claude_mind --path vendor/mng/libs/mngr_pi_coding --path vendor/mng/libs/mngr_mind_chat/
