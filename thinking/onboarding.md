...
- [ ] **Find a way to provide value immediately**: Encourage the user to just dump a bunch of information on you and let you figure it out. Ask questions. Help prioritize and clarify. Suggest ways in which you could help. Keep eliciting information and providing suggestions about how you can help until you find something that resonates with the user, then focus on that.
...
- [ ] **Learn about the user's goals**: Try to understand what is most important, from the user's perspective, and especially what they would like you to help with.
- [ ] **Learn notification preferences**: Ask the user how and when they want to be notified about completed work, issues, and suggestions. Do they want frequent updates or just a daily summary? Are there times they don't want to be disturbed?
