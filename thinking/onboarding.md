...
- [ ] **Learn the GitHub repo**: Ask the user which GitHub repository this mind should manage. Validate access by running `gh repo view <owner/repo>`. Clone it to `/data/local/<repo-name>/` for codebase reference. Save the repo owner/name to memory.
