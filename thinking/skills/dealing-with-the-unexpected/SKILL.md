...
When you encounter such a situation, your best course of action is usually to submit a bug report to the developers so they can investigate and fix the underlying issue. Use the `submit-mng-bug-report` skill to do this **after** collecting as much information about the failure as possible.
